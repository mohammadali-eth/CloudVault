    ...
    <div className="min-h-screen bg-background text-foreground p-12 font-sans selection:bg-foreground selection:text-background">
      ...
      <main className="max-w-4xl space-y-12">
        <div className="space-y-4">
          <h2 className="text-6xl font-heading font-black uppercase tracking-tighter">
            System Access Granted
          </h2>
          <p className="text-muted-foreground font-medium uppercase tracking-widest text-sm italic">
            Status: Secure / Zero Knowledge Protocol Active
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-12">
          <Link
            ...
            className="border-2 border-foreground p-8 space-y-4 hover:bg-foreground hover:text-background transition-all group"
          >
            <h3 className="font-black text-sm uppercase tracking-widest">
              Upload New Object
            </h3>
            <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground group-hover:text-background/60">
              Secure gateway for data ingestion
            </p>
          </Link>
        ...
        <div className="pt-24 space-y-12">
          <div className="space-y-4">
            <h2 className="text-4xl font-heading font-black uppercase tracking-tighter">Vault Objects</h2>
            <p className="text-muted-foreground font-medium uppercase tracking-widest text-[10px] italic">Active File Store / Cloudinary Sync Protocol</p>
          </div>
          <FileList />
        </div>
      </main>
